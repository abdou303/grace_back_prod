...
class UpdateGreffeRequetteRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'copie_cat2' => 'nullable|file|mimes:pdf|max:153600',


            // Validate multiple files for different affaires
            'copie_decision' => 'nullable|nullable|array',
            'copie_decision.*' => 'file|mimes:pdf|max:153600', // Each file must be valid

            'copie_non_recours' => 'nullable|array',
            'copie_non_recours.*' => 'file|mimes:pdf|max:153600', // Each file must be valid
    ...
    public function messages(): array
    {
        return [
            ...
            'copie_decision.*.max' => 'كل ملف في نسخة من المقرر القضائي لا يجب أن يتجاوز 25 ميغابايت.',
            ...
            'copie_non_recours.*.max' => 'كل ملف في شهادة ضبطية او مايفيد حيازة المقرر القضائي لقوة الشيء المقضي به لا يجب أن يتجاوز 25 ميغابايت.',
