...
class UpdateDossierGreffeRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'copie_decision.*.max' => 'نسخة من المقرر القضائي 25 ميغابايت.',
            ...
            'copie_non_recours.*.max' => 'شهادة ضبطية او مايفيد حيازة المقرر القضائي لقوة الشيء المقضي به لا يجب أن يتجاوز 25 ميغابايت.',
